...
def print_results(results_dic, results_stats_dic, model, 
    ...
    # Print model name
    print("\n** Results for {} Model Architecture **".format(model.upper()))
    ...
    # Iterate through results_stats_dic and print percentage values
    ...
    if print_incorrect_dogs and (results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'] != results_stats_dic['n_images']):
        ...
        for filename, labels_list in results_dic.items():
            if sum(labels_list[3:]) == 1:
                print("Pet Image: {}, Classifier Label: {}".format(filename, labels_list[1]))

    if print_incorrect_breed and (results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']):
        print("\nIncorrectly Classified Dog Breeds:")
        for filename, labels_list in results_dic.items():
            if sum(labels_list[3:]) == 2 and labels_list[2] == 0:
                print("Pet Image: {}, Classifier Label: {}".format(filename, labels_list[1]))
