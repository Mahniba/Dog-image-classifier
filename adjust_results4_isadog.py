...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for filename, labels_list in results_dic.items():
        ...
        labels_list.append(int(labels_list[0] in dog_names))

        # Check if the classifier label is a dog
        classifier_labels = labels_list[1].split(', ')
        labels_list.append(int(any(label in dog_names for label in classifier_labels)))
